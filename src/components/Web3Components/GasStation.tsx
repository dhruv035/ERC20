...
import { useToast, useWalletContext } from "@/context/RootContext";
import { ToastTypes } from "../BaseComponents/Toast";
import { useEstimateFeesPerGas } from "wagmi";
import { GasSettings } from "@/lib/types";

const GasStation = ({gasSettings, setGasSettings}: {gasSettings: GasSettings, setGasSettings: Dispatch<SetStateAction<GasSettings>>}) => {
